...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'consumer'];
  ...
  const { data, error, isLoading } = useSWR<CustomerInterface[]>(
    ...
    () => getCustomers({ tenant_id: session?.user?.tenantId }),
  );
  loading = isLoading;
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Vendor', path: '/vendors', entity: 'vendor', service: AccessServiceEnum.PROJECT, icon: FiTruck },
